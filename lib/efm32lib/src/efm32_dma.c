/***************************************************************************//**
 * @file
 * @brief Direct memory access (DMA) module peripheral API for
 *   EFM32 devices.
...
/***************************************************************************//**
 * @addtogroup DMA
 * @brief EFM32 direct memory access utilities.
 * @details
 *  These DMA access utilities provide basic functionality for the following
 *  types of DMA cycles:
 *
